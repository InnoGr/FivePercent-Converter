...
/**
 * Cached reader for money parameter converter
 *
 * @author Vitaliy Zhuk <zhuk2205@gmail.com>
 */
class MoneyPropertyConverterCachedReader implements MoneyPropertyConverterReaderInterface
{
    /**
     ...
     * Construct
     *
     * @param MoneyPropertyConverterReaderInterface $delegate
     * @param CacheInterface                        $cache
     */
    public function __construct(MoneyPropertyConverterReaderInterface $delegate, CacheInterface $cache)
    {
    ...
    {
        $cacheKey = 'property.converter.money.parameters';
